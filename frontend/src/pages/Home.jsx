...
function Home() {
  ...
  const changeBanner = useCallback((index) => {
  ...
  }, [currentBanner, livrosDestaque.length, changeBanner]);



  const banner = livrosDestaque[currentBanner % (livrosDestaque.length || 1)];
